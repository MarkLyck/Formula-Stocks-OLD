      ...
      <section className="what-is-it section">
        ...
        <div className="beside">
            <p className="whatisit-text">
              Formula Stocks is a service, which gives you access to high quality stock
              recommendations. Use these in your own account. Or mirror our portfolio strategy,
