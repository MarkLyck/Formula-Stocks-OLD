...
const Pricing= ({ planData, path }) => (
  <section className="prof-pricing section">
    ...
    <div className="prof-plans">
      <Product plan={planData['premium']} billed="Monthly" path={path}/>
      <Product plan={planData['business']} billed="Annually" path={path}/>
      <Product plan={planData['fund']} billed="Annually" path={path}/>
    </div>
    ...
    <Link className="learn-more button" to={path === '/pro' ? "brochure" : 'pilotTest'} smooth={true} offset={-100} duration={1000}>Learn more</Link>
  </section>
)
