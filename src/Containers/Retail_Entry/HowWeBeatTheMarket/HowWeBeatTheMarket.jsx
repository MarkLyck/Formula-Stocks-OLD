  ...
  render() {
    return (
      <section className="how-to-beat-the-market section">
        ...
        <p>
          Formula Stocks uses a combination of many specific technologies developed over a 14- year period and
          aimed to solve the conundrum put forth by Mark Twain:<br/><br/>
        ...
        <p>
          ...
          selection and portfolio optimization. If you want to know more, please request our brochure or <a onClick={this.downloadBrochure}>click here</a>.
        </p>
      </section>
    )
  }
