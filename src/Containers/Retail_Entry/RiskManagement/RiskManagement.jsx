    ...
    return (
      <section className="section">
        ...
        <p>
          ...
          Formula Stocks is reasonably good at moderating risk, and we believe it yields a lower degree of
          risk than passive stock market investments.<br/><br/>
          ...
          This is the expected return if you were 100% invested at all times. This is not always possible (good
          investments are sometimes scarce), and this leads to an 18.87% annual rate of growth. This is the
          average performance of the Entry method as measured since 1970.
        </p>
      </section>
    )
  }
