...
const PrivacyPolicy = () => (
  <div className="privacy-policy">
    <h2>Privacy Policy</h2>
      ...
      <p>
        When you register an account on our website or application, as part of the process,
        we collect the personal information you give us such as your name, country and email address.
        <br/><br/>
        When you browse our website or application, we also automatically receive your computer’s
        internet protocol (IP) address in order to provide us with information that helps us learn
        about your browser and operating system.<br/><br/>

        Email marketing (if applicable): With your permission, we may send you emails about our
        website or application, new products and other updates.<br/><br/>
      </p>

      <h3>Consent</h3>
      <p>
      When you provide us with personal information, when you register an account, complete a
      transaction, verify your credit card, place an order, arrange for a delivery or return a
      purchase or give us your information in any other way, we imply that you consent to our
      collecting it and using it for that specific reason only.<br/><br/>

      If we ask for your personal information for a secondary reason, like marketing,
      we will either ask you directly for your expressed consent, or provide you with an
      ...
      <h3>Payment</h3>
      <p>
      If you choose a direct payment gateway to complete your purchase, then FORMULA STOCKS stores
      ...
      Act.
      <br/><br/>
      Once you leave our website or application or are redirected to a third-party website or
      ...
      We are not responsible for the privacy practices of other sites and encourage you to read
      ...
      we follow all PCI-DSS requirements and implement additional generally accepted industry
      standards.
      </p>

      <h3>Cookies</h3>
      <p>
      Like most interactive web sites this Company’s website [or ISP] uses cookies to enable us
      to retrieve user details for each visit. Cookies are used in some areas of our site to enable
      the functionality of this area and ease of use for those people visiting. Some of our
      ...
      the website or application. If we make material changes to this policy, we will notify
      ...
      <br/><br/>
      If our website, company or application is acquired or merged with another company, your
      information may be transferred to the new owners so that we may continue to sell products
      to you.
      </p>
      ...
      Compliance Officer at info@formulastocks.com
      </p>
