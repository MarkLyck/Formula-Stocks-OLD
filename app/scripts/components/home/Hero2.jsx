...
class Hero extends React.Component {
  ...
  countUp(element) {
    if (userCanSeeSection) {
      ...
      setTimeout(this.countUp.bind(this, element), Math.round((Math.random() * 1500)) )
    }
  }
          ...
          <div className="content">
            <div className="bounce-down">
              ...
              <div id="subtitles">
                ...
                <h1><span className="font bold">Better investment returns</span></h1>
                <h1><span className="font bold">save money</span></h1>
              </div>
            </div>
