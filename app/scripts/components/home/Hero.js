      ...
      <div id="hero" className={iOSException}>
        <div className="content">
          <div className="bounce-down">
            ...
            <h2>Formula Stocks has a history of picking next year’s winners with an 86-92% average success rate<sup>*</sup>. Give your investments a significant boost – join us today.</h2>
          </div>
