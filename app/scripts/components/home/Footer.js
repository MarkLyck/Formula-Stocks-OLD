      ...
      <footer>
        <div className="disclaimer-container">
          <p className="disclaimer">
            ...
            set your own individual maximum position size accordingly.<br/><br/>

            The period 2009-2016 reflects actual investment results. Other period statistics are
            the result of backtesting the strategies. Backtested performance results have certain
            inherent limitations, as they could potentially be designed with some benefit of hindsight,
            even though every effort have been taken to avoid such risk. Unlike an actual
            live investment period (such as 2009 - 2016), backtested results do not represent actual
