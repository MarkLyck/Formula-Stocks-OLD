...
const Product = React.createClass({
  ...
  render() {
    let extraInfo = this.props.name === 'Premium' ? <p>Includes Basic</p> : this.props.name === 'Business' ? <p>Includes Premium</p> : this.props.name === 'Fund' ? <p>AUM capacity: unlimited</p> : undefined
    return (
      <div className="plan">
        <div className="top">
