    ...
    return (
      <form className={this.state.planFormClasses}>
        ...
        <div className="plans">
          ...
          <button className={fundClass} onClick={this.selectPlan.bind(null, 'fund')}><div><h3 className="plan-name">Fund</h3><h3 className="price">${cc.commafy(store.plans.get('fund').get('price'))}<br/><span className="disclaimer">annually</span></h3></div></button>
        </div>
