...
class SignUp extends React.Component {
  ...
  renderCloseBtn() {
    if (this.props.location.pathname === '/pro/signup') {
      return <Link className="close-btn" to="/pro"><img src="/assets/icons/ic_close.svg"/></Link>
    } else {
      return <Link className="close-btn" to="/"><img src="/assets/icons/ic_close.svg"/></Link>
    }
  }
