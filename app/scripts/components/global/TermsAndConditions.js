  ...
  render() {
    ...
    return (
      <div className="terms-and-conditions">
          ...
          website or our application operated by FormulaStocks ApS.<br/><br/>
          ...
          “FORMULA STOCKS”, “Formula Stocks ApS” "The Company", “Ourselves”, “We” and "Us",
          ...
          stated services/products, in accordance with and subject to, prevailing English Law.
          ...
          with these Terms. These Terms apply to all visitors, users and other who access or use the
          Service.<br/><br/>

          By visiting our website or Application and/ or purchasing something from us, you engage in
          our “Service” and to be bound by the following terms and conditions (“Terms of Service”, “Terms”),
          ...
          limitation users who are browsers, vendors, customers, merchants, and/ or contributors of content.<br/><br/>
          ...
          then you may not access the website or use any services.<br/><br/>

          Any new features or tools which are added to the current service shall also be subject to the
          ...
          the posting of any changes constitutes acceptance of those changes.<br/><br/>
          ...
          any financial instrument or to engage in any specific strategy or as an official confirmation
          of terms.<br/><br/>

          It should not be assumed that the systems presented in these products will be profitable or
          that they will not result in losses. Past results of any investment system published by
          Formula Stocks are not necessarily indicative of future returns. In addition, information,
          system output, articles and other features of our products are provided for educational and
          informational purposes only and should not be construed as investment advice. Accordingly,
          you should not rely solely on this information in making any investment. You should check with
          your licensed financial advisor and tax advisor to determine the suitability of any investment,
          and/or read relevant prospectuses, while taking into account your own financial situation
          and objectives.FORMULA STOCKS plans vary in terms of diversification, and may or may not be
          adequately diversified for any particular risk profile as the required level of diversification
          ...
          Credit card information is always encrypted during transfer over networks. You understand that
          ...
          requirements of connecting networks or devices.<br/><br/>
          ...
          in your state, country or province of residence, or that you are the age of majority in your
          state, country or province of residence and you have given us your consent to allow any of your
          ...
          on this site is at your own risk.<br/><br/>
          ...
          We reserve the right at any time to modify or discontinue the Service (or any part or content
            thereof) without notice at any time.<br/><br/>
          ...
          application. These products or services may have limited quantities and are subject to return
          or exchange only according to our Return Policy.<br/><br/>
          ...
          Any offer for any product or service made on this site is void where prohibited.<br/><br/>
          ...
          billing address/phone number provided at the time the order was made. We reserve the right to
          ...
          purchases made at our website or application. You agree to promptly update your account and
          ...
          tools are provided by the relevant third-party provider(s).<br/><br/>

          We may also, in the future, offer new services and/or features through the website or
          application (including, the release of new tools and resources). Such new features and/or
          ...
          websites, or for any other materials, products, or services of third-parties.<br/><br/>

          We do not monitor or review the content of other party’s websites which are linked to from
          this website or application. Opinions expressed or material appearing on such websites are not
          ...
          of these sites. We encourage our users to be aware when they leave our site & to read the
          privacy statements of these sites. You should evaluate the security and trustworthiness of any
          other site connected to this site or accessed through this site yourself, before disclosing any
          personal information to them. This Company will not accept any responsibility for any loss or
          ...
          any comments; or (3) to respond to any comments.<br/><br/>
          ...
          Service or any related website or application. You may not use a false e-mail address, pretend
          to be someone other than yourself, or otherwise mislead us or third-parties as to the origin of
          any comments. You are solely responsible for any comments you make and their accuracy.
          ...
          typographical errors, inaccuracies or omissions that may relate to information services,
          product descriptions or content, pricing, promotions, offers, product shipping charges,
          transit times and availability. We reserve the right to correct any errors, inaccuracies
          or omissions, and to change or update information or cancel orders if any information in
          the Service or on any related website or application is inaccurate at any time without prior
          ...
          any related website or application, including without limitation, pricing information,
          except as required by law. No specified update or refresh date applied in the Service
          or on any related website or application, should be taken to indicate that all information
          in the Service or on any related website or application has been modified or updated.
          </p>
          ...
          other applications, or the Internet; (h) to collect or track the personal information of
          others; (i) to spam, phish, pharm, pretext, spider, crawl, or scrape; (j) for any obscene or
          immoral purpose; or (k) to interfere with or circumvent the security features of the Service
          or any related website, other websites, other applications, or the Internet.
          We reserve the right to terminate your use of the Service or any related website or application
          ...
          timely, secure or error-free.<br/><br/>

          We make no warranties or representations about the accuracy or completeness of the Web Site’s
          content or the content of any Internet site linked to or from the Web Site.<br/><br/>

          We do not warrant that the results that may be obtained from the use of the service will be
          accurate or reliable.<br/><br/>

          You agree that from time to time we may remove the service for indefinite periods of time or
          cancel the service at any time, without notice to you.<br/><br/>
          ...
          particular purpose, durability, title, and non-infringement.<br/><br/>

          In no case shall FORMULA STOCKS, our directors, officers, employees, affiliates, agents,
          contractors, interns, suppliers, service providers, subsidiaries or licensors be liable for
          ...
          any of the service or any products procured using the service, or for any other claim related
          in any way to your use of the service or any product, including, but not limited to, any errors
          or omissions in any content, or any loss or damage of any kind incurred as a result of the use
          of the service or any content (or product) posted, transmitted, or otherwise made available via
          the service, even if advised of their possibility. Because some states, countries or
          jurisdictions do not allow the exclusion or the limitation of liability for consequential or
          incidental damages, in such states, countries or jurisdictions, our liability shall be limited
          to the maximum extent permitted by law.<br/><br/>

          YOUR USE OF THE WEB SITE IS AT YOUR OWN RISK. TO THE FULLEST EXTENT PERMITTED UNDER APPLIABLE
          LAW, YOU UNDERSTAND AND AGREE THAT NEITHER WE NOR ANY THIRD-PARTY CONTENT PROVIDERS SHALL BE
          LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE, EXEMPLARY OR ANY
          OTHER DAMAGES RELATING TO OR RESULTING FROM YOUR USE OR INABILITY TO USE THE WEB SITE OR ANY
          OTHER SITE YOU ACCESS THROUGH A LINK FROM THE WEB SITE OR FROM ANY ACTIONS WE TAKE OR FAIL TO
          TAKE. THESE INCLUDE DAMAGES FOR ERRORS, OMISSIONS, INTERRUPTIONS, DEFECTS, DELAYS,
          COMPUTER VIRUSES, YOUR LOSS OF PROFITS, LOSS OF DATA, UNAUTHORIZED ACCESS TO AND ALTERATION OF
          YOUR TRANSMISSIONS AND DATA, AND OTHER TANGIBLE AND INTANGIBLE LOSSES. THIS LIMITATION APPLIES
          REGARDLESS WHETHER THE DAMAGES ARE CLAIMED UNDER THE TERMS OF A CONTRACT, AS A RESULT OF
          NEGLIGENCE OR OTHERWISE, AND EVEN IF OUR REPRESENTATIVES OR WE HAVE BEEN NEGLIGENT OR HAVE BEEN
          ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. THESE LIMITATIONS SHALL APPLY NOTWITHSTANDING ANY
          ...
          from these Terms of Service, such determination shall not affect the validity and enforceability
          ...
          survive the termination of this agreement for all purposes.<br/><br/>
          ...
          on the proviso that we are given reasonable notice of such a request. Clients are requested to
          ...
          copies of records as part of an agreed contract, for the benefit of both parties.<br/><br/>

          We will not sell, share, or rent your personal information to any third party or use your
          e-mail address for unsolicited mail. Any emails sent by this Company will only be in connection
          ...
          §  excludes all representations and warranties relating to this website or application and
          its contents or which is or may be provided by any affiliates or any other third party,
          including in relation to any inaccuracies or omissions in this website or application and/or
          the Company’s literature; and
          §  excludes all liability for damages arising out of or in connection with your use of this
          website or application. This includes, without limitation, direct loss, loss of business or
          profits (whether or not the loss of such profits was foreseeable, arose in the normal course of
            things or you have advised this Company of the possibility of such potential loss), damage
          ...
          <p>
          By using the Service, you are consenting to have your personal data transferred to and
          processed by FORMULA STOCKS and its affiliates. As part of providing you the Service,
          we may need to provide you with certain communications, such as service announcements and
          administrative messages. These communications are considered part of the Service,
          which you may not be able to opt-out from receiving.<br/><br/>
          ...
          underway. Any monies that have been paid to us which constitute payment in respect of the
          provision of unused Services, shall be refunded.
          </p>

          <h3>Indemnification</h3>
          <p>
          You agree to indemnify, defend and hold us and all of our affiliates, agents, directors,
          employees, information providers, licensors and licensees and officers (collectively, the
            “Indemnified Parties”) harmless from and against any and all liabilities and costs
            (including, without limitation, attorneys’ fees and costs) incurred by the Indemnified
            Parties in connection with any claim arising out of any breach by you of these Terms and
            Conditions or the representations, warranties and covenants contained herein.
            You will use your best efforts to cooperate with us in the defense of any claim.
            We reserve the right, at our own expense, to assume the exclusive defense and control of
            any matter otherwise subject to indemnification by you and you shall not in any event
          ...
          You are solely responsible for evaluating the fitness for a particular purpose of any downloads,
           programs, data,  content, information and text available through this site. Redistribution or
           republication of any part of this site or its content is prohibited, including such by framing
           or other similar or any other means, without the express written consent of the Company.
           The Company does not warrant that the service from this site will be uninterrupted,
           timely or error free, although it is provided to the best ability. By using this service you
           thereby indemnify this Company, its employees, agents and affiliates against any loss or damage,
           in whatever manner, howsoever caused.
          </p>
          ...
          We use IP addresses to analyse trends, administer the site, track user’s movement, and gather broad
           ...
           identifiable information. Additionally, for systems administration, detecting usage patterns
           and troubleshooting purposes, our web servers automatically log standard access information
           including browser type, access times/open mail, URL requested, and referral URL.
           This information is not shared with third parties and is used only within this Company on a
           need-to-know basis. Any individually identifiable information related to this data will never
          ...
          <p>
          Copyright and other relevant intellectual property rights exists on all text, images,
          charts and data relating to the Company’s services and the full content of this website or
          application.
          </p>
          ...
          diminution of the obligations under this or any Agreement. No waiver of any of the provisions
          of this or any Agreement shall be effective unless it is expressly stated to be such and signed
          by both Parties.
          </p>
          ...
          Denmark, without giving effect to any principles of conflicts of law.
          You agree that any action at law or in equity arising out of or relating to these terms and
          conditions shall be filed only in the courts located in Denmark, and you hereby consent and
          submit to the personal jurisdiction of such courts for the purposes of litigating any such action.
           We recognize that it is possible for you to obtain access to the Web Site from any jurisdiction
           in the world, but we have no practical ability to prevent such access. The Web Site has been
           designed to comply with the laws of Denmark. If any material on the Web Site, or your use of
           the Web Site, is contrary to the laws of the place where you are when you access it,
           the Web Site is not intended for you, and we ask you not to use the Web Site.
           You are responsible for informing yourself of the laws of your jurisdiction and complying with
           them. Some products and services may not be available in all jurisdictions.
          ...
          If any of these terms are deemed invalid or unenforceable for any reason (including, but not
            ...
            Failure of the Company to enforce any of the provisions set out in these Terms and Conditions
            and any Agreement, or failure to exercise any option to terminate, shall not be construed as
            waiver of such provisions and shall not affect the validity of these Terms and Conditions or
            of any Agreement or any part thereof, or the right thereafter to enforce each and every
            provision. These Terms and Conditions shall not be amended, modified, varied or supplemented
            except in writing and signed by duly authorised representatives of the company.
            </p>

          <h3>Entire Agreement</h3>
          <p>
          These Terms, including any legal notices and disclaimers contained on this Website or application,
          constitute the entire agreement between FORMULA STOCKS and you in relation to your use of this
          Website or application, and supersede all prior agreements and understandings with respect to
          the same.
          </p>
          ...
          <p>
          We reserve the right, at our sole discretion, to update, add to, change or replace any part of
          ...
          acceptance of those changes. You are therefore advised to re-read this statement on a regular
          basis.
          </p>

          <h3>Contact information</h3>
          <p>
          Questions about the Terms of Service should be sent to us at info@formulastocks.com.<br/><br/>
          ...
          <p>© Formula Stocks ApS 2015 All Rights Reserved</p>
      </div>
    )
  }
})
