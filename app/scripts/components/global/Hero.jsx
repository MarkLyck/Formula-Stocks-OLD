...
class Hero extends React.Component {
  ...
  render() {
    let title = <h1 id="main-title">A better <span className="font bold">solution</span> for the <span className="font bold">stock market</span></h1>
    ...
    return (
      <header>
        <div className="hero2">
          ...
          {this.props.path !== '/pro' ? <img src="/assets/images/Portfolio_Mockup.png" className="mockup" alt="mockup"/> : ''}
        </div>
      </header>
    )
  }
